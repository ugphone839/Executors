    ...
    const EXECUTOR_DATA = {
        ...
        android: [
            ...
            },
            {
                ...
                version: "2.701",
                status: "Online",
                links: [{ text: "Download", url: "https://www.mediafire.com/file/7iizmrzio32qsve/FluxusZ+V3.0.6+ARM64.apk/file", className: "btn-download-main", statusText: "Status: Online" }]
            }
        ]
    };
